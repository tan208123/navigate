...
import (
	clusterprovisioner_v1alpha1 "github.com/tan208123/navigate/pkg/apis/clusterprovisioner/v1alpha1"
	versioned "github.com/tan208123/navigate/pkg/client/clientset/versioned"
	internalinterfaces "github.com/tan208123/navigate/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/tan208123/navigate/pkg/client/listers/clusterprovisioner/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				return client.ClusterprovisionerV1alpha1().Clusters().List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				return client.ClusterprovisionerV1alpha1().Clusters().Watch(options)
			},
		},
		&clusterprovisioner_v1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&clusterprovisioner_v1alpha1.Cluster{}, defaultClusterInformer)
}
