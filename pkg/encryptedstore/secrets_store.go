...
const (
	defaultNamespace = "navigate-system"
)
...
func NewGenericEncrypedStore(prefix, namespace string, namespaceInterface typedv1.NamespaceInterface, secrets typedv1.SecretsGetter) (*GenericEncryptedStore, error) {
	if namespace == "" {
